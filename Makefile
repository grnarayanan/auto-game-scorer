...
lint:  ## run static analysis with flake8
	python3 -m black --check auto-game-scorer setup.py
	python3 -m flake8 auto-game-scorer setup.py

# Alias
lints: lint

format:  ## run autoformatting with black
	python3 -m black auto-game-scorer/ setup.py
...
annotate:  ## run type checking
	python3 -m mypy ./auto-game-scorer
...
TMPREPO=/tmp/docs/auto-game-scorer
...
pages: 
	rm -rf $(TMPREPO)
	git clone -b gh-pages https://github.com/grnarayanan/auto-game-scorer.git $(TMPREPO)
	rm -rf $(TMPREPO)/*
